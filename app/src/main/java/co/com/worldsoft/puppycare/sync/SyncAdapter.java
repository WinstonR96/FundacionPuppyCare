package co.com.worldsoft.puppycare.sync;
...
import co.com.worldsoft.puppycare.utils.Constantes;
import co.com.worldsoft.puppycare.utils.Utilidades;
import co.com.worldsoft.puppycare.web.Gasto;
import co.com.worldsoft.puppycare.web.VolleySingleton;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String[] PROJECTION = new String[]{
            ...
            ContractParaGastos.Columnas.NOMBRE,
            ContractParaGastos.Columnas.UBICACION,
            ContractParaGastos.Columnas.DESCRIPCION,
            ContractParaGastos.Columnas.IMAGEN
    };
    ...
    private void actualizarDatosLocales(JSONObject response, SyncResult syncResult) {
        ...
        while (c.moveToNext()) {
            ...
            if (match != null) {
                ...
                boolean b = match.nombre != nombre;
                boolean b1 = match.ubicacion != null && !match.ubicacion.equals(ubicacion);
                boolean b2 = match.descripcion != null && !match.descripcion.equals(descripcion);
                boolean b3 = match.imagen != null && !match.imagen.equals(imagen);
                ...
                if (b || b1 || b2 || b3) {
                    ...
                    ops.add(ContentProviderOperation.newUpdate(existingUri)
                            .withValue(ContractParaGastos.Columnas.NOMBRE, match.nombre)
                            .withValue(ContractParaGastos.Columnas.UBICACION, match.ubicacion)
                            .withValue(ContractParaGastos.Columnas.DESCRIPCION, match.descripcion)
                            .withValue(ContractParaGastos.Columnas.IMAGEN, match.imagen)
                            .build());
        ...
        for (Gasto e : expenseMap.values()) {
            ...
            ops.add(ContentProviderOperation.newInsert(ContractParaGastos.CONTENT_URI)
                    ...
                    .withValue(ContractParaGastos.Columnas.NOMBRE, e.nombre)
                    .withValue(ContractParaGastos.Columnas.UBICACION, e.ubicacion)
                    .withValue(ContractParaGastos.Columnas.DESCRIPCION, e.descripcion)
                    .withValue(ContractParaGastos.Columnas.IMAGEN, e.imagen)
                    .build());
