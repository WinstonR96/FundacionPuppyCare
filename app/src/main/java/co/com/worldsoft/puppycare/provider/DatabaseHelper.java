...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createTable(SQLiteDatabase database) {
        String cmd = "CREATE TABLE " + ContractParaGastos.PERRO+ " (" +
                ContractParaGastos.Columnas._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ContractParaGastos.Columnas.NOMBRE + " TEXT, " +
                ContractParaGastos.Columnas.UBICACION + " TEXT, " +
                ContractParaGastos.Columnas.DESCRIPCION + " TEXT, " +
                ContractParaGastos.Columnas.IMAGEN + " TEXT," +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        try { db.execSQL("drop table " + ContractParaGastos.PERRO); }
