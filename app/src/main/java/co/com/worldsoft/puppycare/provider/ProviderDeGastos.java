...
public class ProviderDeGastos extends ContentProvider {
     ...
     */
    private static final String DATABASE_NAME = "crunch_dogs.db";
    /**
    ...
    public Cursor query(
        ...
        switch (match) {
            case ContractParaGastos.ALLROWS:
                ...
                c = db.query(ContractParaGastos.PERRO, projection,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        long rowId = db.insert(ContractParaGastos.PERRO, null, contentValues);
        if (rowId > 0) {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case ContractParaGastos.ALLROWS:
                affected = db.delete(ContractParaGastos.PERRO,
                        selection,
                        selectionArgs);
                break;
            case ContractParaGastos.SINGLE_ROW:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (ContractParaGastos.uriMatcher.match(uri)) {
            case ContractParaGastos.ALLROWS:
                affected = db.update(ContractParaGastos.PERRO, values,
                        selection, selectionArgs);
                break;
            case ContractParaGastos.SINGLE_ROW:
